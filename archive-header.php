...
<?php if (!empty($this->options->HeeaderShow) && in_array('HeeaderShowState3', $this->options->HeeaderShow)): ?>
...
<div class="main-section mdui-color-theme header-dark">
        ...
        <br><br><br><br><br><br><br><br><br><br>
          <?php $this->archiveTitle(array(
              'category'  =>  _t('%s</h1> <h4>分类'),
              'search'    =>  _t('%s</h1> <h4>包含关键字'),
              'tag'       =>  _t('%s</h1> <h4>标签'),
              'author'    =>  _t('%s</h1> <h4>时间'),
          ), '<h1>', '</h1>'); ?>
