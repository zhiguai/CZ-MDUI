...
<head>
  ...
  <?php else: ?>
    <link rel="icon" href="<?php $this->options->themeUrl('img/icon.png'); ?>" type="image/x-icon" />
    <link rel="shortcut icon" href="<?php $this->options->themeUrl('img/icon.png'); ?>" type="image/x-icon"/>
  <?php endif; ?>
  
  <?php if ($this->options->imgHead): ?>
    <style>
    /* 头部壁纸 */
    .main-section {
        background: url(<?php $this->options->imgHead() ?>) no-repeat center;
        /*background: url() 50% 17vh no-repeat; */
        background-size: cover;
    }
    /* 卡片 */
    .main-section-card {
        background: url(<?php echo img_postthemb($this,'https://z3.ax1x.com/2021/07/27/WhYQZd.png')?>) no-repeat center;
        background-size: cover;
...
<?php if (!empty($this->options->HeeaderShow) && in_array('HeeaderShowState1', $this->options->HeeaderShow)): ?>
...
<div class="main-section mdui-color-theme header-dark" id="top">
		<div class="mdui-container">
			<div class="logo-container">
        <?php if (!empty($this->options->sidebarBlock) && in_array('ShowRecentLogo', $this->options->sidebarBlock)): ?>
          <?php if ($this->options->logoUrl): ?>
              <img src="<?php $this->options->logoUrl(); ?>" class="logo">
          <?php else: ?>
              <img src="<?php $this->options->themeUrl('img/ic_bangumi_timeline_first_dialog.png'); ?>" class="logo">
          <?php endif; ?>
        <?php else: ?>
        ...
        <br><br><br><br><br><br><br><br><br><br><br>
            ...
            <span class="link_single" mdui-tooltip="{content: '文章总数'}">
              <i class="mdui-icon material-icons">&#xe865;</i> <a href="#" rel="nofollow" class="main-meta-btn"><?php $stat->publishedPostsNum() ?></a>
            </span>
            <span class="link_single" mdui-tooltip="{content: '分类总数'}">
              <i class="mdui-icon material-icons">&#xe431;</i> <a href="#" rel="nofollow" class="main-meta-btn"><?php $stat->categoriesNum() ?></a>
            </span>
            <span class="link_single" mdui-tooltip="{content: '评论总数'}">
              <i class="mdui-icon material-icons">&#xe0b7;</i> <a href="#" rel="nofollow" class="main-meta-btn"><?php $stat->publishedCommentsNum() ?></a>
            </span>
            <span class="link_single" mdui-tooltip="{content: '页面总数'}">
              <i class="mdui-icon material-icons">&#xe02f;</i> <a href="#" rel="nofollow" class="main-meta-btn"><?php $stat->publishedPagesNum() ?></a>
            </span>
				</div>
			</div>
		</div>
